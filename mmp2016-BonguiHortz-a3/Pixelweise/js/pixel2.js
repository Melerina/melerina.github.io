...
var pixel = {
    updateSchwellWert: function (newVal) {
        document.getElementById('sWertPegel2').innerHTML = newVal;
    },
...
//Berechne Differenz zwischen Pixelfarbe prev und next
        ...
        if (Math.abs(dif1 - dif2) >= ((this.video.videoWidth * this.video.videoHeight) * .98)) {
            var video3 = document.getElementById("4video");
    ...
    log: function (text) {
        var logArea = document.getElementById("pixel-log2");
        if (logArea) {
    ...
    computeFrame: function () {
        ...
        if (this.cachedImg) {
            var diffImage = this.getDifference(this.cachedImg, frame, document.getElementById('schwellWert2').value);
    ...
    doLoad: function () {
        ...
        try {
            this.video = document.getElementById("4video");
            this.c1 = document.getElementById("4c1");
            this.c2 = document.getElementById("4c2");
